...
describe('Ejercicio 10: Tienda Online - Parte 1: Estructura y Página Principal', () => {
    const basePath = path.join(__dirname, '../../src/tienda-online');
    
    // Tests de estructura de carpetas
    describe('Estructura de Carpetas', () => {
        test('debe existir la carpeta src/tienda-online/', () => {
    ...
    // Tests de archivos de recursos básicos
    describe('Archivos de Recursos Básicos', () => {
    ...
    // Tests de contenido HTML - index.html
    ...
    // Tests de imágenes básicas
    describe('Imágenes Básicas', () => {
        ...
        test('debe existir al menos tres imágenes de productos', () => {
    ...
    // Tests de vinculación de recursos
    describe('Vinculación de Recursos en index.html', () => {
        test('index.html debe vincular el archivo CSS', () => {
            const indexPath = path.join(basePath, 'index.html');
            if (fs.existsSync(indexPath)) {
                const content = fs.readFileSync(indexPath, 'utf8');
        ...
        test('index.html debe vincular el archivo JavaScript', () => {
            const indexPath = path.join(basePath, 'index.html');
            if (fs.existsSync(indexPath)) {
                const content = fs.readFileSync(indexPath, 'utf8');
